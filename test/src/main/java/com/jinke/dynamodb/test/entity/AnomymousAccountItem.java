...
@DynamoDBTable(tableName = "ikylin_rc_anonymous_account")
public class AnomymousAccountItem implements Serializable {
     ...
     * 主键，用户名(not null)
     */
    @DynamoDBHashKey(attributeName = "anonymous_name")
