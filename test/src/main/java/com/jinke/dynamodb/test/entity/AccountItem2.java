...
@DynamoDBTable(tableName = "ikylin_test_account2")
public class AccountItem2 implements Serializable {
...
/*    public static long getSerialVersionUID() {
    ...
    public AccountItem2 setAccountName(String accountName) {
    ...
    public AccountItem2 setOpenId(String openId) {
        this.openId = openId;
        return this;
    }
    ...
    public AccountItem2 setAccountType(Integer accountType) {
    ...
    public AccountItem2 setMobile(String mobile) {
        this.mobile = mobile;
        return this;
    }
    ...
    public AccountItem2 setRegisterTime(Long registerTime) {
    ...
    public AccountItem2 setPwd(String pwd) {
        this.pwd = pwd;
        return this;
    }
    ...
    public AccountItem2 setPlamformId(Integer plamformId) {
    ...
    public AccountItem2 setChannelId(Integer channelId) {
